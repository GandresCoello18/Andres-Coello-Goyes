...
import Contenido from "./contenido/contenido-php";
import AsidePost from "../../componentes/aside_derecho_post";
import Footer from "../../componentes/footer";
import "../../componentes/css/bootstrap.css";
import portada from "../../componentes/portada_articulos/php-importancia.webp";
            ...
            <div className="container-fluid">
                <div className="row">
                    ...
                    <div className="col-12 col-lg-10">
                        <PortadaPost titulo="PHP - ¿Que es?" color="#fff" portada={portada} />
                    </div>
